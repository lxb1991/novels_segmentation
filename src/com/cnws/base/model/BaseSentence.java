...
public class BaseSentence extends Sentence{

    public BaseSentence() {
        super();
    }

    public BaseSentence(List<String> words, List<String> pos, List<String> feature) {
    ...
    public void genFeatureSeperate(String word, String pos, String pWord, String pPOS, String ppWord,
                                   String ppPOS, Map<String, String> pos2hash) {
        // 1
    ...
    public static Sentence genGoldenFeature(Sentence golden, int wordLen, Map<String, String> pos2hash) {
        BaseSentence goldenSentence = new BaseSentence();
        int nowLen = 0;
        String ppWord = "#";
        String ppPOS = "#";
        String pWord = "#";
